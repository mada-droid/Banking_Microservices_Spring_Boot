    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        if (isApiSecured.test(request)) {
            ...
            final List<String> apiEndpointsEmployee = List.of(
                    ...
                    "/api/account/inactivation/accounts/" + stringArrayList.get(0),

                    //Activate a specific account passing in its id(theId)
                    "/api/account/activation/accounts/" + stringArrayList.get(0));
            ...
            final List<String> apiEndpointsClient = List.of(
                    ...
                    //add mapping for upload/get profile picture of each user
                    "/api/auth/upload/image/" + stringArrayList.get(0),"/api/auth/get/image/info/"+stringArrayList.get(0),
                    "/api/auth/get/image/"+stringArrayList.get(0),
                    ...
                    "/api/account/closure_request/accounts/" + stringArrayList.get(0),
