...
public class JwtAuthenticationFilter implements GatewayFilter {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        final List<String> apiEndpoints = List.of("/register", "/auth", "/userdetails");
        ...
        if (isApiSecured.test(request)) {
            ...
            final List<String> apiEndpointsEmployee = List.of("/api/auth/users/" + stringArrayList.get(0) + "/delete",
            ...
            final List<String> apiEndpointsClient = List.of("/api/account/users/" + stringArrayList.get(0) + "/accounts",
                    "/api/transaction/transaction", "/api/transaction/transfer",
