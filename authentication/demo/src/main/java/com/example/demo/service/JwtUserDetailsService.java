...
public class JwtUserDetailsService implements UserDetailsService {
	...
	public Utente save(UtenteDTO utente) {
		Utente newUtente = new Utente(utente.getFirstName(),
				utente.getLastName(), utente.getEmail(),
				utente.getBirthDate(),/*utente.getUsername()*/
				bcryptEncoder.encode(utente.getPassword()));

		HttpEntity<Utente> request = new HttpEntity<>(new Utente(utente.getFirstName(),
				utente.getLastName(), utente.getEmail(),
				utente.getBirthDate(),/*utente.getUsername()*/
				bcryptEncoder.encode(utente.getPassword())));
