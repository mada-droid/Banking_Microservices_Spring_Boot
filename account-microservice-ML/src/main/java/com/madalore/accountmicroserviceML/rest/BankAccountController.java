...
public class BankAccountController {
    ...
    @GetMapping("/accounts/activation/{theId}")
    ...
    //Activate a specific account passing in its id(theId)
    @GetMapping("/accounts/inactivation/{theId}")
    ...
    @GetMapping("/accounts/closure_request/{theId}")
    ...
    // that must be firstly validated by the employee
    @GetMapping("/accounts/activation_request/{theId}")
